...
selectDirector.addEventListener('change', () => {
      let seleccionDir= selectDirector.value;      
      let resultDir= filtrarDirector(seleccionDir);
      return (resultDir);
});

selectProductor.addEventListener('change', () => {
      let seleccionPro= selectProductor.value;      
      let resultPro= filtrarProductor(seleccionPro);
      return (resultPro);
});
